              ...
              <div className="lg:order-1">
                ...
                <div className="flex flex-col items-start mt-8 sm:space-x-4 sm:flex-row sm:items-center lg:mt-12">
                  <a
                    href="#"
                    title=""
                    className="inline-flex items-center justify-center px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-gradient-to-r from-fuchsia-600 to-blue-600 border border-transparent rounded-full hover:bg-blue-700 focus:bg-blue-700"
                    role="button"
                  >
                    <svg
                  ...
                  <a
                    href="#"
                    title=""
                    className="inline-flex items-center justify-center px-4 py-4 mt-5 text-base font-semibold text-white transition-all duration-200 bg-transparent border border-white rounded-full sm:mt-0 hover:bg-white hover:text-black"
                    role="button"
                  >
                    {" "}
                    Explore UI Blocks{" "}
